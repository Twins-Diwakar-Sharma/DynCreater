...
public:
    ...
    void setUniform(std::string, Vec3&&);
    void setUniform(std::string, Quat&);
    void setUniform(std::string, Quat&&);
    ...
    void mapJointMatricesArrayUniform(std::string name);
    void setJointMatricesArrayUniform(std::string name, std::vector<Mat4>& currentFrame);
};
